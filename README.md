...
A web dApp that integrates with the [Shell](https://get.keycard.tech/mmlado) hardware wallet entirely via QR codes — no browser extension, no USB, no Bluetooth. Everything goes through the camera.
